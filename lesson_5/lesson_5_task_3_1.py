...
try:
    ...
    print(
        f"Размер списка и кнопок Delete в Chrome: {len(chrome_delete_buttons)}")
    print(
        f"Размер списка и кнопок Delete в Firefox: {len(firefox_delete_buttons)}")
